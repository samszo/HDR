...
Entre la dimension des physicalités organisée en hiérarchies et celle des concepts organisée en topologies, la dimension des actants organise l'espace des connaissances à la fois sous la forme de topos et de chora. Topos et chora sont deux manière complémentaires de définir l'espace soit sous la forme d'un identité par exemple "Université Paris 8", soit par ce que le lieu génére comme activité, par exemple dans le cas de Paris 8 : recherches et enseignements. 

  Les actants sont topos car ils définissent des lieux par un nom et une position sur Terre, par exemple "Université Paris 8" et le nom d'un espace géographique dmodélise l'espace par des noms graphies dans le sens où elle défini l'organisation des lieux en ce qu'il 'qu'elle occupe et les relations  
