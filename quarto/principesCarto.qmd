...
![Visualisattion des triplets RDF](https://upload.wikimedia.org/wikipedia/commons/a/a8/Sch%C3%A9ma_triplet.png){#fig-tripletRDF fig-align="center"}
...
Les recherches menées en théories des graphes [@moretti2008] ont montré leur souplesse dans la capacité de mettre en relation des éléments hétérogènes les uns avec les autres où : 
> « la réalité abordée est réduite à des symboles sans signification pour être soumise à des manipulations aveugles. » [@bachimont2020]. 
...
[^principescarto-37-1]:
    > <https://fr.wikipedia.org/wiki/Triplet_RDF>
