...
Pour modéliser les rapports, nous reprenons les principes que recommande le W3C avec le format « Open Annotation »[^principescarto-36] qui code de façon très simple les relations entre des ressources sémantiques afin de définir un point de vue particulier sur celles-ci. Suivant ce modèle une "annotation" est ce qui met en rapport un "body" à une "target". De notre point de vue, la modélisation du rapport est donc une "annotation" qui dans un ici et maintenant va mettre en relation deux ressources. On retrouve ici :
-   le modèle hypertextuel basique : nœud - ancre - lien [@balpe1996], 
-   le triplet RDF : sujet - objet - prédicat [@gandon2012],
-   la définition élémentaire d'une analogie : source - destination - même [@hofstadter].
...
```{mermaid}
graph LR
    root((rapports possibles)):::classOK-->sujetP((S. P.)):::classKO
    root-->sujetA((S. A.)):::classOK
    root-->sujetC((S. C.)):::classKO
    root-->sujetR((S. R.)):::classKO
    sujetP-->objetPP((O. P.)):::classKO
    sujetP-->objetPA((O. A.)):::classKO
    sujetP-->objetPC((O. C.)):::classKO
    sujetP-->objetPR((O. R.)):::classKO
    sujetA-->objetAP((O. P.))
    sujetA-->objetAA((O. A.))
    sujetA-->objetAC((O. C.))
    sujetA-->objetAR((O. R.))
    sujetC-->objetCP((O. P.)):::classKO
    sujetC-->objetCA((O. A.)):::classKO
    sujetC-->objetCC((O. C.)):::classKO
    sujetC-->objetCR((O. R.)):::classKO
    sujetR-->objetRP((O. P.)):::classKO
    sujetR-->objetRA((O. A.)):::classKO
    sujetR-->objetRC((O. C.)):::classKO
    sujetR-->objetRR((O. R.)):::classKO

    objetPP-->predPPP((P. P.)):::classKO
    objetPP-->predPPA((P. A.)):::classKO
    objetPP-->predPPC((P. C.)):::classKO
    objetPP-->predPPR((P. R.)):::classKO
    objetPA-->predPAP((P. P.)):::classKO
    objetPA-->predPAA((P. A.)):::classKO
    objetPA-->predPAC((P. C.)):::classKO
    objetPA-->predPAR((P. R.)):::classKO
    objetPC-->predPCP((P. P.)):::classKO
    objetPC-->predPCA((P. A.)):::classKO
    objetPC-->predPCC((P. C.)):::classKO
    objetPC-->predPCR((P. R.)):::classKO
    objetPR-->predPRP((P. A.)):::classKO
    objetPR-->predPRA((P. A.)):::classKO
    objetPR-->predPRC((P. C.)):::classKO
    objetPR-->predPRR((P. R.)):::classKO

    objetAP-->predAPP((P. P.)):::classKO
    objetAP-->predAPA((P. A.)):::classKO
    objetAP-->predAPC((P. C.)):::classOK
    objetAP-->predAPR((P. R.)):::classOK
    objetAA-->predAAP((P. P.)):::classKO
    objetAA-->predAAA((P. A.))
    objetAA-->predAAC((P. C.))
    objetAA-->predAAR((P. R.))
    objetAC-->predACP((P. P.))
...
On le voit, la majeur partie des relations sont pour nous incohérentes puisque sur 34 possibilités nous n'en retenons que 10. Insistons sur le fait que ces incohérences le sont de notre point vue et que d'autres personnes pourrait considérer que d'autres rapport sont possibles suivant leurs manières de voir les connaissances. C'est ici que se situe les débats scientifiques, par exemple peut-on considérer comme sujet uniquement les actants ? Les concepts peuvent-ils être des objects ? A l'inverse, les phisicalités peuvent-elles êtres des prédicats ? 
