...
Suite à la présentation de nos positionnements scientifiques @sec-positionnements et des principes pour la modélisation @sec-principesTheo et la cartographie @sec-principesCarto des connaissances, nous développerons dans ce chapitre nos perspectives de scientifiques et comment elles se déploient dans des projets de recherches spécifiques suivant des niveaux d'échelles et des axes d'expérimentations que nous explorons avec l'objectif principal de lutter contre un « amincissement du monde » et une représentation de la pensée qui supprime la multiplicité des modes d'existences :
