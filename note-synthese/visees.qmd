...
Nous souhaitons poursuivre ces investigations en continuant la parution de nouveaux articles dans la revue et en organisant de nouvelles conférences dans le cadre du congrès Digital Tools & Uses. Plus particulièrement, en lien avec nos propres recherches, nous voulons questionner les méthodes de pilotages des objets connectés au niveau global avec les smart cities et au niveau local avec la domotique familiale. Par exemple, ce qui nous intéresse c'est d'analyser comment rendre accessible la complexité des flux infocommunicationnels de l'IOT afin de rendre son pilotage plus efficace pour la lutter contre les dérèglements climatiques ou pour préserver la vie privée. Pour ce faire nous envisageons de mettre en place un protocole d'observation participante à la manière de l'observatoire des jardins[^visees-6] à partir une plateforme d'intelligence collective.

[^visees-6]: Lien vers une explication du protocole : <https://www.oiseauxdesjardins.fr/index.php?m_id=1127&item=18>

Parallèllement à nos travaux sur les puissances existentielles @sec-puissanceExistentielle et sur l'éthique @sec-axeFormaConsensus, les objectifs de cet axe sont :

-   préconiser des usages à partir des données collectées

-   aider à la définition des politiques publiques

-   calculer des pictogrammes présentant le niveau éthique des objets connectés.
...
Outre les problématiques de transposition didactique [@tasra], ce qui nous intéresse ici c'est la capacité des diagrammes [@jedrzejewski2007] et autres représentations graphiques a effectivement transmettre leurs pouvoirs de discernement, de raisonnement et d'action . Pour étudier ces phénomènes, nous construisons depuis une dizaine d'années une base de connaissances rassemblant les documents graphiques utilisés par des chercheurs pour expliciter un point de leur argumentation. Cette collection contient aujourd'hui plus d'une centaine de documents que nous avons récolté manuellement.

Nous souhaitons développer cet axe dans 3 directions :

-   automatiser la récolte des graphiques présents dans les thèses et autres documents scientifiques en nous inspirant des travaux en IA menés à la BNF [@moreux2019] et à partir de corpus constitué avec ISTEX[^visees-9] sur des thématiques correspondant à nos axes de recherche.

-   mettre cette collection de graphiques à la disposition des chercheurs et des étudiants pour qu'ils évaluent leurs pouvoirs avec des cribles conceptuels @sec-modeliserCrible.

-   questionner les capacités des IA à produire des modèles à partir de ces documents et à générer à partir de textes scientifiques des diagrammes :
...
Ce qui est en jeu avec cet axe, c'est à la fois :

-   analyser les puissances de la norme déployées par les méthodes et les outils du Web sémantique et du Linked Open Data (LOD)

-   construire une éthique de la discussion par une formalisation des échanges ayant pour but l'éducation de l'esprit critique par la stimulation des pouvoirs de discerner, raisonner, agir.

-   comprendre les effets du pilotage par les données du métier de chercheur en SHS.

D'un point de vue éthique, l'enjeu est de stimuler "une formation de la volonté" à travers des règles pratiques d'échanges [@habermas2013, p. 22] afin d'exercer sa "volonté" en tant qu'individu ou qu'institution face à une situation de choix :
...
#### Développer les usages du métamodèle

Notre souhaitons réfléchir aux possibilités d'utiliser ce modèle alliant complexité et pouvoirs pour simuler les états potentiels d'une existence informationnelle. Les objectifs sont :

-   améliorer l'analyse de cette existence,

-   prédire des évolutions,

-   recommander quelles dimensions existentielles des existence devront être développées pour parvenir à un état particulier.

Par exemple, l'idée serait de montrer les différents états possibles pour que l'écosystème de connaissances d'un collégien évolue vers celui d'un boulanger, d'un journaliste, d'un footballeur professionnel ou d'un poète. À cet exemple d'usage individuel, nous pourrions en ajouter une infinité d'autres par exemple des usages collectives pour définir les stratégies d'un territoire ou des usages purement intellectuels pour évaluer les différences entre deux auteurs. Ces évolutions entre un état n d'un écosystème de connaissances et un état n+1 pourraient être représentées sous la forme d'un tableau de bord permettant de définir des objectifs et de suivre leur niveau d'achèvement.

#### Modéliser des puissances existentielles de références
