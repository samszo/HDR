...
Pour faciliter ces calculs, nous avons développer un algorithme pour Omeka S[^7] qui utilise les informations de la base de données pour calculer la complexité d'une ou de plusieurs existences suivant le principe qu'une ressource Omeka S est une existence. Cette algorithme se compose de deux parties, une première qui calcule pour une ressource le nombre d'élément de chaque dimension et une deuxième qui calcule la complexité à partir de ce dénombrement.
...
-   infos
    ...
    -   resources[^10] : liste des ressources impliquée dans le calcul avec les informations :
