...
Le second principe se base sur les travaux de [@hofstadter2013] pour qui l'analogie est le « moteur » qui relie le discernement et l'action en gardant le souvenir de cette relation qui devient à force de répétition, une manière d'être et selon Deleuze la forme d'un « pli » qui est notre troisième principe  :
...
A partir des principes que nous venons du définir nous élaborons un méta-modèle conçu comme "un générateur de modèles qualitatifs" [@thom1975, p. 372] pour nos analyses de l'information et la communication. Ce modèle s'appuie sur une corrélation entre des dimensions existentielles et des genres de connaissances.
